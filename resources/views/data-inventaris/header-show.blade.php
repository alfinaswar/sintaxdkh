            <div class="card profile-overview profile-overview-wide">
                    ...
                    <div class="clearfix d-xl-flex flex-grow-1">
                        <div class="clearfix pe-md-5">
                            ...
                            <ul class="d-flex flex-wrap fs-6 align-items-center">
                                <li class="me-3 d-inline-flex align-items-center">
                                    <i class="las la-barcode me-1 fs-18"></i>Serial Number: {{ $data->SerialNumber ?? '-' }}
                                </li>
                                <li class="me-3 d-inline-flex align-items-center">
                                    <i class="las la-tag me-1 fs-18"></i>Merk: {{ $data->getMerk->Merk ?? '-' }}
                                </li>
                                <li class="me-3 d-inline-flex align-items-center">
                                    <i class="las la-info-circle me-1 fs-18"></i>Tipe: {{ $data->Tipe ?? '-' }}
                                </li>
                            </ul>
                            <div class="d-md-flex d-none flex-wrap">
                                <div class="border outline-dashed rounded p-2 d-flex align-items-center me-3 mt-3">
                                    ...
                                    <div class="clearfix ms-2">
                                        <h3 class="mb-0 fw-semibold lh-1">
                                            {{ $data->getDepartemen->NamaDepartemen ?? '-' }} -
                        ...
                        <div class="clearfix mt-3 mt-xl-0 ms-auto d-flex flex-column col-xl-3">
                            @php
                                ...
                                $warna = '';
                                $label = '';
                                switch (strtoupper(trim($klasifikasi))) {
                                    case 'HIGH-RISK':
                                        $warna = 'danger';
                                        $label = 'High Risk';
                                        break;
                ...
                <div class="card-footer py-0 d-flex flex-wrap justify-content-between align-items-center px-0">
                    <ul class="nav nav-underline nav-underline-primary nav-underline-text-dark nav-underline-gap-x-0"
                        ...
                        <li class="nav-item ms-1" role="presentation">
                            <a href="{{ route('data-inventaris.Wo', encrypt($data->id)) }}" class="nav-link py-3 border-3 text-black">
                                Work Order
                            </a>
                        </li>
                        <li class="nav-item ms-1" role="presentation">
                            <a href="{{ route('data-inventaris.Pm', encrypt($data->id)) }}" class="nav-link py-3 border-3 text-black">
