                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        @forelse ($data->getPm->take(5) as $pm)
                                            <div
                                                class="d-flex align-items-start py-3 hover-bg-light rounded my-1 flex-column">
                                                    ...
                                                    <div class="col-6 text-center">
                                                        ...
                                                        @if ($pm->Before)
                                                            <img src="{{ asset('storage/preventif/before/' . $pm->Before) }}"
                                                                alt="Before" class="img-fluid rounded"
                                        ...
                                        @forelse ($data->getKalibrasi->take(5) as $kalibrasi)
                                            <div
                                                ...
                                                <div class="d-flex align-items-center w-100">
                                                    ...
                                                    <div class="clearfix ms-auto">
                                                        <span
                                                            class="badge badge-sm badge-info">{{ $kalibrasi->StatusKalibrasi }}</span>
                                                    </div>
                                                    <div class="clearfix ms-auto">
